...
// Particle::Particle(string const &path) {
//     loadParticle(path);
// }

// // draws the model, and thus all its meshes
// void Particle::drawParticle(Shader &shader)
// {
...
// void Particle::loadParticle(string const &path)
// {
...
// void Particle::processNode(aiNode *node, const aiScene *scene)
// {
...
// Mesh Particle::processMesh(aiMesh *mesh, const aiScene *scene)
// {
//     // data to fill
...
// vector<Texture_> Particle::loadMaterialTextures(aiMaterial *mat, aiTextureType type, string typeName)
// {
//     vector<Texture_> textures;
...
//             Texture_ texture;
//             texture.id = TextureFromFileParticle(str.C_Str(), this->directory);
